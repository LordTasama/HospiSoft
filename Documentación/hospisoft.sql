...
--
ALTER TABLE `historiasclinicas`
  ADD CONSTRAINT `historiasclinicas_ibfk_1` FOREIGN KEY (`id_paciente`) REFERENCES `paciente` (`identificacion`),
  ADD CONSTRAINT `historiasclinicas_ibfk_2` FOREIGN KEY (`id_medico`) REFERENCES `medico` (`identificacion`);
